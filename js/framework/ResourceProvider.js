...
var ResourceProvider = Class.create({
	initialize: function() {
	...
	_didLoad: function(fileName, resource) {
	 ...
	 * @return:Image
	 */
	getImage: function(fileName, fnOnLoad) {
	...
	loadImage: function(fileName, fnOnLoad) {
		var RP = this;
	 ...
	 * @return:Sprite
	 */
	getSprite: function(fileName, fnOnLoad) {
	...
	loadSprite: function(fileName, fnOnLoad) {
		var RP = this;
	...
	getJson: function(fileName, fnOnLoad) {
	...
	loadJson: function(fileName, fnOnLoad) {
		var RP = this;
	...
	setResource: function(fileName, res) {
